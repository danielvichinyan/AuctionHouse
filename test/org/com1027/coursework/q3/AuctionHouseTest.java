...
public class AuctionHouseTest {
  ...
  public void testAuctionHouseCreation() {
    ...
    BiddableProduct product = new BiddableProduct(1,"ball",10.00);
  ...
  public void testEndAuctionWithNoBidsOrPurchases() {
    AuctionHouse ahouse1 = new AuctionHouse();
    BiddableProduct product1 = new BiddableProduct(1,"ball",10.00);
  ...
  public void testRegisterandBuyNow() {
    AuctionHouse ahouse1 = new AuctionHouse();
    BuyNowProduct product = new BuyNowProduct(1,"ball",10.00,9);
  ...
  public void testEntriesForDisplayAllPurchases() {
    AuctionHouse ahouse1 = new AuctionHouse();
    BiddableProduct product1 = new BiddableProduct(1,"ball",5.00);
